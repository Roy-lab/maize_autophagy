...
MOTIFDIR=/ahg/regev/users/sroy/compfuncgen/data/Motifs_IlanNoami/
...
LISTDIR=/ahg/regev/users/sroy/compfuncgen/fordawn/sfp1
...
DIR=$LISTDIR/$SUBSTR/speciesspecific_lists
#DIR=$LISTDIR/$SUBSTR/
...
do
	...
	GENELIST=$TOPDIR/${SPECIES}_speciespecnames_clusterassign.txt
	...
	echo "bsub -o scratch/selectqueries_$ITER.txt ./enrichAnalyzer $NWFILE $GENELIST $MOTIFFILE 1 $OUTSUFF persg"
	bsub -q hour -o scratch/selectqueries_$ITER.txt ./enrichAnalyzer $NWFILE $GENELIST $MOTIFFILE 1 $OUTSUFF persg
