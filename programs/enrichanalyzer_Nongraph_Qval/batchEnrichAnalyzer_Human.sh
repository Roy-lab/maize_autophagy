...
HIGHCONFREGNET=/home/local/MORGRIDGE/sroy/results/networkinference/pgpm/humanES/zeromean_withsignaling/edgec_1_regnet.txt
MSIGDB=/home/local/MORGRIDGE/sroy/data/msigdb/genenames_msigpath_regnet.txt
CHIPNET=/home/local/MORGRIDGE/sroy/data/human/tfnet/humanes_chip/H1_chip_regnet.txt
CHIPNET=/home/local/MORGRIDGE/sroy/data/human/tfnet/humanes_chip/H1_chip_correct_regnet.txt
...
#	./enrichAnalyzer $NWFILE $GENELIST $GOFILE 0.05 $OUTSUFF persg
	...
	#./enrichAnalyzer $NWFILE $GENELIST $DNASENET4 0.05 $RESDIR/module_dnaseenr_proc4_c0.6 persg
